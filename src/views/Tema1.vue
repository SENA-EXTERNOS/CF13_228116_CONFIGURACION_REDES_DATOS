  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bloque-texto-g.color-secundario.p-3.p-sm-4.p-md-5.mb-4
      ...
      .bloque-texto-g__texto.p-4(data-aos="fade-left")
        img.img-02.col-lg.d-none.d-lg-flex(src="@/assets/curso/temas/img01.svg")
        p El proceso de instalación de redes para una plataforma de infraestructura tecnológica se estructura en dos pilares fundamentales: la instalación de componentes eléctricos, inicialmente, y el montaje de los componentes que conforman el cableado estructurado.<br><br>
        .h5.mb-0 En la instalación eléctrica se desarrollan los pasos correspondientes a la implementación de las piezas que lo conforman, como son las tomas, los cables eléctricos, las acometidas, las canaletas y las señales reguladas, cuya función principal es suministrar la corriente y el voltaje necesarios para su correcto funcionamiento.
    ...
    p.mb-5 Este último tipo de red determina el soporte para la implementación de los sistemas integrados de voz, datos, vídeo y multimedia, sin importar el fabricante de cada uno de estos.

    .h4 Aspectos a tener en cuenta antes de comenzar la instalación de una red
    p.mb-5 Para lograr una práctica eficiente en la instalación de un proyecto de cableado estructurado de forma confiable y segura, en primera instancia es fundamental tener en cuenta lo siguiente:

    .row.justify-content-start.align-items-center.mb-5
      .col-lg-8.order-lg-1.order-2
        .BGR03A.p-4(data-aos="fade-right")
          p.me-5.mb-0 Conocer los lineamientos prácticos que garanticen un trabajo con calidad teniendo en cuenta, en un segundo momento, la experiencia en estas actividades.   
        .BG04.p-4(data-aos="fade-right")
          p.me-5.mb-0 Los estándares de calidad, los cuales son unos protocolos internacionales que indican un contexto sólido y confiable para el implemento de un proyecto de cableado.
        .BG03.p-4(data-aos="fade-right")
          p.me-5.mb-0 Las normas establecidas tienen   un proceso de revisión, monitoreo y actualización que se llevan a cabo por unos comités interdisciplinarios. Los miembros y no miembros solicitantes de dichos grupos pueden participar de las actualizaciones continuas.
        .BGR04A.p-4(data-aos="fade-right")
          p.me-5.mb-0 La vigencia de dichas normas puede   variar según su naturaleza; por ejemplo, las normas TIA tienen un periodo de cinco años, mientras que las análogas de ISO, aproximadamente tres años de duración.
    ...
    .row.justify-content-start.align-items-center.mb-4(data-aos="zoom-in")
      SlyderF(columnas="col-lg-6 col-xl-4")
        .tarjeta-avatar
          ...
          .BGR05.hg-1.p-4
            p.text-center.mt-5.mb-0 Verificar la conexión y determinar que el cableado está en buenas condiciones, que transmita sin problemas; además, hay que hacer pruebas en la continuidad de atenuación y la impedancia.
        .tarjeta-avatar
          img(src='@/assets/curso/tema1/img04.svg' alt='AvatarTop')
          .BGR05.hg-1.p-4
            p.text-center.mt-5.mb-0 Observar que las conexiones sean las correctas, es decir, que no tengan falsos contactos que puedan afectar al rendimiento.
        .tarjeta-avatar
          img(src='@/assets/curso/tema1/img05.svg' alt='AvatarTop')
          .BGR05.hg-1.p-4
            p.text-center.mt-5.mb-0 Comprobar que los equipos de comunicación como los switches, los routers y los puntos de acceso inalámbricos (wifi) funcionen correctamente.
        .tarjeta-avatar
          img(src='@/assets/curso/tema1/img06.svg' alt='AvatarTop')
          .BGR05.hg-1.p-4
            p.text-center.mt-5.mb-0 Constatar el estado de la tarjeta de red, tanto de los servidores como de las estaciones de trabajo, de tal manera que el funcionamiento sea totalmente correcto.
        .tarjeta-avatar
    ...
    .BGIMG01.p-4.mb-4(data-aos="zoom-in")
      SlyderA(tipo="b")
        ...
        .row.justify-content-center
          .col-lg-5.order-lg-1.order-2
            .h4 Circuito cerrado de televisión
            ...
            p.mb-0 El circuito puede estar compuesto por una o más cámaras de vigilancia conectadas a uno o más monitores de vídeo o televisores que reproducen las imágenes capturadas. Para lograr que el sistema sea más eficiente actualmente se conectan directamente o se enlazan por red otros componentes como videos o computadoras.
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
